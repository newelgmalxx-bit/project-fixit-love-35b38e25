        ...
        <section id="partner-form" className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-xl">
            ...
            <form onSubmit={submit} className="grid grid-cols-1 gap-4 p-6 sm:grid-cols-2">
              ...
              {/* اختيار الباقة (اختياري — يديرها الادمن) */}
              {packages.length > 0 && (
                <div className="sm:col-span-2 space-y-3">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-extrabold text-foreground">طلبات إضافية ( الاشتراك في الاعلان الممول ) <span className="text-[11px] font-normal text-muted-foreground">— اختياري</span></label>
                    <span className="text-[11px] text-muted-foreground">السداد يتم خارج المنصة</span>
                  </div>
