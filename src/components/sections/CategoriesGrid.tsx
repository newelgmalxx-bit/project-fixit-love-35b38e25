          ...
          <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-2 lg:grid lg:grid-cols-12 lg:overflow-visible lg:pb-0">
            {categories.map((c: any, idx) => {
              ...
              return (
                ...
                >
                  <SmartImage src={c.cover} alt={name} width={400} height={400} sizes="(max-width: 1024px) 90vw, 400px" widths={[240, 320, 480, 640]} className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
