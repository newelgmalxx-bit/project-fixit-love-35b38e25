              ...
              {reviews.map((r) => (
                ...
                >
                  ...
                  <div className="mt-5 flex items-center gap-3 border-t border-border pt-5">
                    {r.userAvatar ? (
                      <img src={r.userAvatar} alt={r.userName} loading="lazy" decoding="async" width={40} height={40} className="h-10 w-10 rounded-full object-cover ring-2 ring-primary/15" referrerPolicy="no-referrer" />
                    ) : (
