...
import { flagSA, flagUS } from "@/lib/flags";
              ...
              <PopoverContent align="end" className="w-60 p-2" dir={lang === "ar" ? "rtl" : "ltr"}>
                ...
                {isPartner ? (
                  ...
                  <>
                    ...
                    <Link to={"/account/bookings" as any} onClick={() => setAcctOpen(false)} className="flex items-center gap-2 rounded-md px-2 py-2 text-sm hover:bg-muted">
                ...
                <div className="flex flex-col">
                  {isPartner ? (
                    ...
                    <>
                      ...
                      <Link to={"/account/bookings" as any} onClick={() => setOpen(false)} className="flex items-center gap-2 rounded-md px-2 py-2.5 text-sm hover:bg-muted">
                        <Package className="h-4 w-4" /> {t("account.nav.orders")}
                      </Link>
